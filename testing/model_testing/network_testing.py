...
def net_test():
    ...
    my_net.add_layer(
        LayerNetworkInfo(layer_length=40, activation=Activations.SIGMOID, initialization=Initializations.RANDOM))
    my_net.add_layer(
        LayerNetworkInfo(layer_length=40, activation=Activations.TANH, initialization=Initializations.RANDOM))
    my_net.add_layer(
        LayerNetworkInfo(layer_length=8, activation=Activations.RELU, initialization=Initializations.RANDOM))
    my_net.add_layer(
